  ...
  return (
    <div className="group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
      ...
      <div className="relative overflow-hidden bg-gray-50 aspect-square">
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md hover:bg-pink-600 hover:text-white transition-colors duration-200"
          >
            <svg
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md hover:bg-gray-800 hover:text-white transition-colors duration-200"
          >
            <svg
              className="fill-current"
              width="18"
        ...
        {/* Product Image */}
        <Link href={`/products/${item?.slug}`} onClick={() => handleProductDetails()}>
        ...
        {/* <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
          <button
            ...
            className="w-full bg-[#991B4D] hover:bg-[#7a1639] text-white font-medium py-3 px-6 rounded-md transition-colors duration-200 flex items-center justify-center gap-2"
          >
      ...
      <div className="p-4">
        ...
        {/* Product Title */}
        <h3 className="font-medium text-gray-900 mb-2 line-clamp-2 min-h-[2.5rem]" onClick={() => handleProductDetails()}>
          <Link href={`/products/${item?.slug}`} className="hover:text-[#991B4D] transition-colors duration-200">
            {item.title}
          </Link>
        </h3>
