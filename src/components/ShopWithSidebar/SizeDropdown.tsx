...
const SizeDropdown = ({ selectedSizes = [], onSelectionChange }: SizeDropdownProps) => {
      ...
      >
        {sizes.map((size) => (
          <button
            ...
            className={`cursor-pointer select-none flex items-center text-custom-sm py-[5px] px-3.5 rounded-[5px] ${
